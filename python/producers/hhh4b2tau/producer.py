...
from PhysicsTools.NanoNN.producers.hhh4b2tau.common import (
...
from PhysicsTools.NanoNN.producers.hhh4b2tau.gen import GenHistoryMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.objects import ObjectSelectionMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.corrections import CorrectionsMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.pairing import HiggsPairingMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.triggers import TriggerMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.fill_event import EventFillMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.fill_jets import JetFillMixin
from PhysicsTools.NanoNN.producers.hhh4b2tau.fill_objects import LeptonFillMixin
...
class HHH4b2tauProducer(
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        # weight variables
        self._declare_event_branches()
        # fatjets
        self._declare_fatjet_branches()

        # dihiggs variables
        self._declare_pairing_branches()

        self._declare_jetlevel_branches()
        self._declare_counter_branches()

        # Multi-trigger path branches
        self._declare_trigger_branches()

        self._declare_jet_branches()

        # leptons
        self._declare_sf_branches()

        self._declare_lepton_branches()

        # gen variables
        self._declare_gen_branches()

        # Tau pair kinematics (filled by fillLepPairInfo for all events, not MC-only)
        self._declare_taupair_branches()
